<!DOCTYPE html>
    ...
    <body>
        <div class="jumbotron text-center"><h1 style="color: white;">Menu of the Restaurant</h1></div>
       

        <div class="cont">
            <h1>Select the item of your choice from the menu and see it's details</h1>
          </div>
